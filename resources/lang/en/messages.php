...
return [
    ...
    "enter_your_mpesa_number_to_receive_a_payment_prompt" => "Enter your M-Pesa number to receive a payment prompt on your phone",
    "mpesa_phone_number" => "M-Pesa phone number",
    "send_payment_request" => "Send payment request",
    "check_your_phone" => "Check your phone",
    "an_mpesa_prompt_has_been_sent_enter_your_pin_to_complete_payment" => "An M-Pesa prompt has been sent. Enter your PIN on your phone to complete payment",
    "do_not_close_this_page_until_payment_is_confirmed" => "Do not close this page until payment is confirmed",
    "delivery_details" => "Delivery details",
    "quick_checkout_for_mpesa_fill_dropdowns_below" => "Quick checkout — select your location below, then pay with M-Pesa",
    "full_name" => "Full name",
    "you_will_receive_mpesa_prompt_on_this_number" => "You will receive the M-Pesa prompt on this number",
    "county" => "County",
    ...
    "e.g._near_supermarket_or_estate_gate" => "e.g. near supermarket or estate gate",
    "pay_with_mpesa_on_next_step" => "Pay with M-Pesa on the next step",
    "pay_now_with_mpesa" => "Pay now with M-Pesa",
    "mpesa_prompt_will_be_sent_to" => "M-Pesa prompt will be sent to",
    "mpesa_is_not_enabled_please_enable_it_in_admin_payment_methods" => "M-Pesa is not enabled. Enable it in Admin → Payment Methods and add your .env credentials",
    "or" => "or",
    "mpesa_payment_successful" => "Payment successful",
    "mpesa_insufficient_funds" => "Insufficient M-Pesa balance. Please top up and try again",
    "mpesa_payment_cancelled" => "Payment was cancelled on your phone",
    "mpesa_payment_timeout" => "Payment timed out. No response received from M-Pesa",
    "mpesa_wrong_pin" => "Wrong M-Pesa PIN entered",
    "mpesa_payment_expired" => "Payment request expired. Please try again",
    "mpesa_system_error" => "M-Pesa system error. Please try again later",
    "mpesa_payment_failed" => "Payment failed. Please try again",
    "redirecting_to_order_confirmation" => "Redirecting to order confirmation...",
