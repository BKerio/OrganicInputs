        ...
        <div class="row mx-max-md-0">
            <section class="col-lg-8 px-max-md-0">
                <div class="checkout_details">
                    ...
                    @if($simpleKenyaCheckout ?? false)
                        @include('web-views.checkout.shipping-mpesa-simple')
                    @elseif($physical_product_view)
                    ...
                    @if($billingInputByCustomer && !($simpleKenyaCheckout ?? false))
                        <div>
...
@push('script')
    ...
    @if($simpleKenyaCheckout ?? false)
        ...
        <script src="{{ theme_asset(path: 'public/assets/front-end/js/kenya-checkout.js') }}"></script>
    @endif

    @if(getWebConfig('map_api_status') ==1 && !($simpleKenyaCheckout ?? false))
        <script
