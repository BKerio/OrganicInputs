                        ...
                        <div class="card-body p-0">
                            ...
                            @else
                                @if($simpleKenyaCheckout ?? false)
                                    ...
                                    @include('web-views.checkout.payment-mpesa-simple')
                                @else
                                ...
                                <div class="p-20">
                                    ...
                                    @if (!($simpleKenyaCheckout ?? false) && isset($offline_payment) && $offline_payment['status'] && count($offline_payment_methods) > 0)
                                        <div class="row g-3">
                                            <div class="col-12">
