...
@section('content')
    ...
    @include('vendor-views.pos.partials.modals._mpesa-pending-modal')
    ...
    <span id="route-vendor-pos-mpesa-stk-push" data-url="{{ route('vendor.pos.mpesa.stk-push') }}"
          data-pending-text="{{ translate('an_mpesa_prompt_has_been_sent_enter_your_pin_to_complete_payment') }}"></span>
    <span id="route-vendor-pos-mpesa-status" data-url="{{ route('vendor.pos.mpesa.status') }}"></span>
    <span id="route-vendor-pos-mpesa-complete-order" data-url="{{ route('vendor.pos.mpesa.complete-order') }}"></span>
