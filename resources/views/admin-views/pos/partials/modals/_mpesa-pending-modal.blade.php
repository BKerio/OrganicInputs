<div class="modal fade" id="posMpesaPendingModal" tabindex="-1" aria-labelledby="posMpesaPendingModalLabel" aria-hidden="true"
            ...
            <div class="modal-body p-4 text-center" id="pos-mpesa-status-card">
                ...
                <div id="pos-mpesa-result-view" style="display: none;">
                    ...
                    <div class="d-flex flex-column gap-2 align-items-center">
                        <button type="button" class="btn btn-primary px-4" id="pos-mpesa-retry-btn" style="display: none;" data-bs-dismiss="modal">
                            {{ translate('try_again') }}
                        </button>
                    </div>
                </div>
