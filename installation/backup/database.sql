...
--
-- Host: localhost:8889
-- Generation Time: Mar 10, 2026 at 06:57 AM
...
('070c766c-d777-11ed-96f4-0c7a158e4469', '2factor', '{\"gateway\":\"2factor\",\"mode\":\"live\",\"status\":\"0\",\"api_key\":\"data\",\"otp_template\":\"OTP1\"}', '{\"gateway\":\"2factor\",\"mode\":\"live\",\"status\":\"0\",\"api_key\":\"data\",\"otp_template\":\"OTP1\"}', 'sms_config', 'live', 0, NULL, '2026-03-10 06:57:32', NULL),
...
(18, 'colors', '{\"primary\":\"#1b7fed\",\"secondary\":\"black\",\"primary_light\":\"#CFDFFB\"}', '2020-10-11 13:53:02', '2026-03-10 06:57:31'),
...
(49, 'social_login', '[{\"login_medium\":\"google\",\"client_id\":\"\",\"client_secret\":\"\",\"status\":1},{\"login_medium\":\"facebook\",\"client_id\":\"\",\"client_secret\":\"\",\"status\":1}]', NULL, '2026-03-10 06:57:32'),
...
(104, 'apple_login', '[{\"login_medium\":\"apple\",\"client_id\":\"\",\"client_secret\":\"\",\"status\":1,\"team_id\":\"\",\"key_id\":\"\",\"service_file\":\"\",\"redirect_url\":\"\"}]', NULL, '2026-03-10 06:57:32'),
...
(1, 'Kenyan Shilling', 'Ksh', 'KES', '1', 1, NULL, '2021-06-27 13:39:37'),
...
CREATE TABLE `delivery_men` (
  ...
  `full_phone` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(17, '::1', NULL, '2026-03-10 06:57:35', '2026-03-10 06:57:35');
...
(363, '2026_02_25_163505_add_indexes_to_orders_table', 89),
(364, '2026_02_25_163601_add_indexes_to_products_table', 89),
(365, '2026_02_25_163645_add_indexes_to_order_details_table', 89),
(366, '2026_02_25_163731_add_indexes_to_shops_table', 89),
(367, '2026_02_26_172145_add_full_phone_to_delivery_men_table', 89),
(368, '2026_03_10_112011_add_method_type_with_comment_to_withdraw_requests_table', 89);
...
(7, 'customer', 'order_failed_message', 'Order fa Message', 0, '2023-10-30 11:02:55', '2026-03-10 06:57:32'),
...
(0, 'Walk-In Customer', 'Walk-In', 'Customer', '000000000000', 'def.png', 'walking@customer.com', NULL, '', NULL, NULL, '2026-03-10 06:57:32', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, 'en');
...
CREATE TABLE `withdraw_requests` (
  ...
  `request_method_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'system or vendor',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `orders`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_orders_seller_is_seller_id` (`seller_is`,`seller_id`),
  ADD KEY `idx_orders_status_created_at` (`order_status`,`created_at`),
  ADD KEY `idx_orders_customer_id_status` (`customer_id`,`order_status`),
  ADD KEY `idx_orders_edited_due` (`edited_status`,`edit_due_amount`),
  ADD KEY `idx_orders_edited_return` (`edited_status`,`edit_return_amount`),
  ADD KEY `idx_orders_payment_method_seller_is` (`payment_method`,`seller_is`),
  ADD KEY `idx_orders_seller_id_payment_status` (`seller_id`,`payment_status`),
  ADD KEY `idx_orders_deliveryman_status` (`delivery_man_id`,`order_status`),
  ADD KEY `idx_orders_created_at` (`created_at`),
  ADD KEY `idx_orders_payment_status` (`payment_status`),
  ADD KEY `idx_orders_order_type` (`order_type`),
  ADD KEY `idx_orders_is_guest` (`is_guest`),
  ADD KEY `idx_orders_coupon_code` (`coupon_code`),
  ADD KEY `idx_orders_checked` (`checked`),
  ADD KEY `idx_orders_transaction_ref` (`transaction_ref`),
  ADD KEY `idx_orders_order_group_id` (`order_group_id`),
  ADD KEY `idx_orders_shipping_responsibility` (`shipping_responsibility`);
...
ALTER TABLE `order_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_order_details_order_id_delivery_status` (`order_id`,`delivery_status`),
  ADD KEY `idx_order_details_product_id_delivery_status` (`product_id`,`delivery_status`),
  ADD KEY `idx_order_details_seller_id_delivery_status` (`seller_id`,`delivery_status`),
  ADD KEY `idx_order_details_order_id_payment_status` (`order_id`,`payment_status`),
  ADD KEY `idx_order_details_delivery_status` (`delivery_status`),
  ADD KEY `idx_order_details_refund_request` (`refund_request`);
...
ALTER TABLE `products`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_products_added_by_user_id` (`added_by`,`user_id`),
  ADD KEY `idx_products_added_by_request_status` (`added_by`,`request_status`),
  ADD KEY `idx_products_category_id_status` (`category_id`,`status`),
  ADD KEY `idx_products_sub_category_id_status` (`sub_category_id`,`status`),
  ADD KEY `idx_products_sub_sub_category_id_status` (`sub_sub_category_id`,`status`),
  ADD KEY `idx_products_brand_id_status` (`brand_id`,`status`),
  ADD KEY `idx_products_added_by_product_type_user` (`added_by`,`product_type`,`user_id`),
  ADD KEY `idx_products_slug` (`slug`),
  ADD KEY `idx_products_current_stock` (`current_stock`),
...
ALTER TABLE `shops`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_shops_seller_id_author_type` (`seller_id`,`author_type`),
  ADD KEY `idx_shops_author_type` (`author_type`);
